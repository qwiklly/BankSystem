namespace WindowsFormsApp4
{
    partial class Deposit
    {
        ...
        private void InitializeComponent()
        {
			...
			this.label7.Size = new System.Drawing.Size(259, 105);
			this.label7.TabIndex = 40;
			this.label7.Text = "Введите количество рублей для снятия денег со вклада";
			// 
			// label6
			// 
			...
			this.textBox2.Location = new System.Drawing.Point(690, 375);
			...
			this.Button1.Location = new System.Drawing.Point(690, 504);
			...
			this.label3.Text = "Введите количество рублей для вклада";
			// 
			// label2
			// 
